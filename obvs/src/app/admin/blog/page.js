...
export default function BlogAdminPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.ok) {
      ...
      setSnackbar({
        open: true,
        message: editingPost ? "Blog post updated!" : "Blog post added!",
        severity: "success",
      });
    } else {
      const data = await res.json();
            ...
            <Box>
                ...
                <ButtonGroup variant="outlined" size="small" sx={{ mb: 1 }}>
                  ...
                  <Tooltip title="Underline">
                    <Button
                      ...
                      color={
                        editor.isActive("underline") ? "primary" : "inherit"
                      }
                    >
                  ...
                  <Tooltip title="Bullet List">
                    <Button
                      ...
                      color={
                        editor.isActive("bulletList") ? "primary" : "inherit"
                      }
                    >
                  ...
                  <Tooltip title="Ordered List">
                    <Button
                      ...
                      color={
                        editor.isActive("orderedList") ? "primary" : "inherit"
                      }
                    >
                  ...
                  <Tooltip title="Blockquote">
                    <Button
                      ...
                      color={
                        editor.isActive("blockquote") ? "primary" : "inherit"
                      }
                    >
                      <FormatQuoteIcon />
                    </Button>
                  ...
                  <Tooltip title="Code">
                    <Button
                      ...
                      color={
                        editor.isActive("codeBlock") ? "primary" : "inherit"
                      }
                    >
                      <CodeIcon />
                    </Button>
              ...
              <Paper
                ...
                sx={{
                  p: 2,
                  minHeight: 200,
                  "& .ProseMirror": { outline: "none", minHeight: 150 },
                }}
              >
